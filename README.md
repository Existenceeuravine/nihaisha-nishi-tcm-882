...
```bash
git clone https://github.com/Existenceeuravine/nihaisha-nishi-tcm-882.git
cd nihaisha-nishi-tcm-882
python setup.py
```
...
[![GitHub stars](https://img.shields.io/github/stars/JuneYaooo/nihaisha-tcm?style=flat)](https://github.com/Existenceeuravine/nihaisha-nishi-tcm-882/stargazers)
...
```text
帮我安装 nihaisha skill：
https://github.com/Existenceeuravine/nihaisha-nishi-tcm-882
```
...
```bash
git clone git@github.com:Existenceeuravine/nihaisha-nishi-tcm-882.git
cd nihaisha-tcm
...
<!-- Last updated: 2026-06-06 16:34:52 -->
